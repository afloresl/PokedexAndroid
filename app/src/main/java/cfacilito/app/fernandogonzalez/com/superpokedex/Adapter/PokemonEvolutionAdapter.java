package cfacilito.app.fernandogonzalez.com.superpokedex.Adapter;
...
import cfacilito.app.fernandogonzalez.com.superpokedex.Interface.IItemClickListener;
import cfacilito.app.fernandogonzalez.com.superpokedex.Model.Evolution;
import cfacilito.app.fernandogonzalez.com.superpokedex.R;
...
public class PokemonEvolutionAdapter extends RecyclerView.Adapter<PokemonEvolutionAdapter.MyViewHolder> {
    ...
    public PokemonEvolutionAdapter(Context context, List<Evolution> evolutions) {
        ...
        if(evolutions != null)
            ...
            this.evolutions = new ArrayList<>(); //Aqui se corrige si el pokemon no tiene prev/next evolution
    }
