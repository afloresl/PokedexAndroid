package cfacilito.app.fernandogonzalez.com.superpokedex.Model;
...
public class Pokemon {
    ...
    public Pokemon(int id, String num, String name, String img, List<String> type, String height, String weight, String candy, int candy_count, String egg, double spawn_chance, double avg_spawns, String spawn_time, List<String> weaknesses, List<Evolution> next_evolution, List<Evolution> prev_evolution) {
        this.id = id;
        this.num = num;
        this.name = name;
        this.img = img;
